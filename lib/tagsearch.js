        ...
        if (typeof fun == "function") {
            ...
            for (var i = 0; i < sorttag.length; i++) {
                ...
                if (sorttag[i].p == 0) {
                    ...
                    var e_str = this.substring(sorttag[i].s + sorttag[i].l);
                    lend = sorttag[i].s + sorttag[i].l;
                    console.log("mmmmmmmmmmmmmmmm", sorttag[i].s, sorttag[i].l, this.length)
                    console.log(b_str)
                    console.log(e_str)
                    tmpstr += b_str + (fun(sorttag[i].c, sorttag[i].s, sorttag[i].l, sorttag[i].p) || "") + e_str;
                }
            }
            return tmpstr;
        }
